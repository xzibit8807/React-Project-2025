...
(function (global, factory) {
    ...
    function onRegister(context, tokens, query, body) {
        console.log("body is:" + body + "token:" + tokens);

        return context.auth.register(body);
    }

    function onLogin(context, tokens, query, body) {
        console.log("body is:" + body + "and token is:" + tokens);
        ...
        games: [
            {
                ...
                "description": "Ultimate Mortal Kombat 3 was released to arcades in 1995. It is an update of Mortal Kombat 3, featuring altered gameplay, additional characters, and new arenas. Various home versions of the game were released soon afterward, although none of these were completely identical to the arcade version.",
            ...
            },
            {
                ...
                "_createdOn": 1742238372475,
                "_id": "23420d7c-3c8a-4d67-b608-b256228e60dc"
            }
        ]
        // games: {
        //     "-game-1": {
